namespace Teltec.Everest.App.Forms
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.backupPlanListControl1 = new Teltec.Everest.App.Forms.BackupPlan.BackupPlanListControl();
			this.tpgRestorePlans = new System.Windows.Forms.TabPage();
			this.restorePlanListControl1 = new Teltec.Everest.App.Forms.RestorePlan.RestorePlanListControl();
