namespace Teltec.Everest.App.Forms.NetworkCredentials
{
	partial class AddEditNetworkCredentialForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.cbMountPoint = new Teltec.Everest.App.Controls.DriveItemsComboBox();
			this.drivesBindingSource1 = new Teltec.Everest.App.Controls.DriveItemsBindingSource(this.components);
